    ...
    if request.user.is_authenticated:
        try:
            ...
            permissions = {
                ...
                'can_create_clients': any(role in ['SuperAdmin', 'Manager', 'Leader'] for role in role_names),
                'can_view_programs': any(role in ['SuperAdmin', 'Staff', 'Manager', 'Leader'] for role in role_names),
                'can_manage_programs': any(role in ['SuperAdmin'] for role in role_names),
                'can_create_programs': any(role in ['SuperAdmin', 'Manager', 'Leader'] for role in role_names),
                'can_view_departments': any(role in ['SuperAdmin', 'Manager', 'Leader'] for role in role_names),
                'can_manage_departments': any(role in ['SuperAdmin'] for role in role_names),
                'can_view_enrollments': any(role in ['SuperAdmin', 'Staff', 'Manager', 'Leader'] for role in role_names),
                'can_manage_enrollments': any(role in ['SuperAdmin', 'Manager', 'Leader'] for role in role_names),
                'can_create_enrollments': any(role in ['SuperAdmin', 'Manager', 'Leader'] for role in role_names),
                'can_view_restrictions': any(role in ['SuperAdmin', 'Staff', 'Manager', 'Leader'] for role in role_names),
                'can_manage_restrictions': any(role in ['SuperAdmin', 'Manager', 'Leader'] for role in role_names),
                'can_create_restrictions': any(role in ['SuperAdmin', 'Manager', 'Leader'] for role in role_names),
                'can_view_reports': any(role in ['SuperAdmin', 'Staff', 'Manager', 'Leader', 'Analyst'] for role in role_names),
                ...
                'can_view_audit_log': any(role in ['SuperAdmin'] for role in role_names),
                ...
                'can_view_dashboard': any(role in ['SuperAdmin', 'Staff', 'Manager', 'Leader', 'Analyst'] for role in role_names),
                'is_program_manager': 'Manager' in role_names,
                'is_leader': 'Leader' in role_names,
                'is_analyst': 'Analyst' in role_names,
                'is_staff_only': 'Staff' in role_names and not any(role in ['SuperAdmin', 'Manager', 'Leader', 'Analyst'] for role in role_names),
            }
