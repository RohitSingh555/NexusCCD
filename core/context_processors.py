    ...
    if request.user.is_authenticated:
        try:
            ...
            permissions = {
                ...
                'can_create_programs': any(role in ['SuperAdmin', 'Admin', 'Leader'] for role in role_names),
                ...
                'can_view_upload_logs': any(role in ['SuperAdmin', 'Admin', 'Leader'] for role in role_names),
