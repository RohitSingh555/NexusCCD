    ...
    if request.user.is_authenticated:
        try:
            ...
            permissions = {
                ...
                'can_create_clients': any(role in ['SuperAdmin', 'Admin'] for role in role_names),
                ...
                'can_create_programs': any(role in ['SuperAdmin', 'Admin'] for role in role_names),
                ...
                'can_create_departments': any(role in ['SuperAdmin', 'Admin'] for role in role_names),
                'can_view_duplicates': any(role in ['SuperAdmin', 'Admin'] for role in role_names),
                'can_export_clients': any(role in ['SuperAdmin', 'Admin', 'Leader', 'Analyst'] for role in role_names),
                'can_view_upload_logs': any(role in ['SuperAdmin', 'Admin'] for role in role_names),
                ...
                'can_create_enrollments': any(role in ['SuperAdmin', 'Admin', 'Leader'] for role in role_names),
                ...
                'can_export_reports': any(role in ['SuperAdmin', 'Admin', 'Leader', 'Analyst'] for role in role_names),
