    ...
    if request.user.is_authenticated:
        try:
            ...
            permissions = {
                ...
                'can_view_programs': any(role in ['SuperAdmin', 'Admin', 'Staff', 'Manager', 'Leader'] for role in role_names),
                ...
                'can_view_enrollments': any(role in ['SuperAdmin', 'Admin', 'Staff', 'Manager', 'Leader'] for role in role_names),
                ...
                'can_view_reports': any(role in ['SuperAdmin', 'Admin', 'Staff', 'Manager', 'Leader', 'Analyst'] for role in role_names),
