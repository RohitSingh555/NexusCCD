...
urlpatterns = [
    ...
    path('<uuid:external_id>/toggle-status/', views.toggle_program_status, name='toggle_status'),
    ...
    path('<uuid:external_id>/enrollments/', views.fetch_enrollments_ajax, name='fetch_enrollments'),
