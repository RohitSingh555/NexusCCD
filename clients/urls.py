...
urlpatterns = [
    ...
    path('dedupe/run-scan/', views.run_duplicate_scan, name='dedupe_run_scan'),
    path('dedupe/delete-high-confidence/', views.delete_high_confidence_duplicates, name='dedupe_delete_high_confidence'),
